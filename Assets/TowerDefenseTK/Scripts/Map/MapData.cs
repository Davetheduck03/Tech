...
namespace TowerDefenseTK
{
    ...
    public class MapData : ScriptableObject
    {
        ...
        public bool IsWalkable(Vector2Int coords)
        {
            ...
            return tile.type != TileType.Blocked;
        }
        ...
        public bool IsBuildable(Vector2Int coords)
        {
            ...
            return tile.type == TileType.Buildable || tile.type == TileType.Empty;
        }
    ...
    public enum TileType
    {
        ...
        Buildable,  // Not walkable, buildable (tower spots)
        Spawn,      // Enemy spawn point
        Exit        // Enemy exit point (player base)
    }
}